...
public enum U implements GeneratorParamEnum {
    ...
    SATBAND_TX_AMP("SATBAND_TX_AMP") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(100.0);
            param.setValue(89.87217249893767);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    SEQ_DESCRIPTION("SEQ_DESCRIPTION") {
        public Param build() {
            ...
            param.setDescription("");
            param.setCategory(Category.Acquisition);
            param.setValue("GE_3D_AXI_64x64x32_FATSAT_TOFSAT");
            param.setDefaultValue("");
            return param;
        }
    },
    ...
    SPECTRAL_WIDTH("SPECTRAL_WIDTH") {
        public Param build() {
            ...
            param.setValue(16009.22131147541);
    ...
    TOF2D_SB_OFFSET("TOF2D_SB_OFFSET") {
        public Param build() {
            NumberParam param = new NumberParam();
            param.setName("TOF2D_SB_OFFSET");
            param.setDisplayedName("TOF2D_SB_OFFSET");
            param.setDescription("");
            param.setGroup(EnumGroup.Emission);
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.FrequencyOffset);
    ...
    TOF3D_MOTSA_OVERLAP("TOF3D_MOTSA_OVERLAP") {
        public Param build() {
            NumberParam param = new NumberParam();
            param.setName("TOF3D_MOTSA_OVERLAP");
            param.setDisplayedName("TOF3D_MOTSA_OVERLAP");
            param.setDescription("");
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.PERCENT);
    ...
    TOF3D_MT_FLIP_ANGLE("TOF3D_MT_FLIP_ANGLE") {
        public Param build() {
            ...
            param.setMaxValue(1.7976931348623157E308);
            param.setValue(1000.0);
            param.setDefaultValue(4.9E-324);
            return param;
        }
    },
    ...
    TRIGGER_TIME("TRIGGER_TIME") {
        public Param build() {
            ...
            param.setMaxValue(1.0E9);
            param.setNumberEnum(NumberEnum.Time);
            param.setValue(asListNumber(0.0, 98.4, 196.8));
    ...
    TX_AMP("TX_AMP") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(100.0);
            param.setValue(72.85887629433343);
            param.setDefaultValue(40.0);
            return param;
        }
    },
