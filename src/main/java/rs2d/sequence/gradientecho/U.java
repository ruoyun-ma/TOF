...
public enum U implements GeneratorParamEnum {
    ...
    ECHO_TRAIN_LENGTH("ECHO_TRAIN_LENGTH") {
        public Param build() {
            ...
            param.setDisplayedName("ECHO_TRAIN_LENGTH");
            param.setDescription("Echo Train Length for multiecho acquisition");
            param.setLocked(true);
            param.setGroup(EnumGroup.Delay);
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.Scan);
    ...
    NUMBER_OF_SLAB("NUMBER_OF_SLAB") {
        public Param build() {
            ...
            param.setDisplayedName("NUMBER_OF_SLAB");
            param.setDescription("");
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.Scan);
            param.setMinValue(1);
    ...
    SATBAND_TX_AMP("SATBAND_TX_AMP") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(100.0);
            param.setValue(23.931361339686273);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    SEQ_DESCRIPTION("SEQ_DESCRIPTION") {
        public Param build() {
            ...
            param.setCategory(Category.Acquisition);
            param.setValue("GE_3D_AXI_256x256x4_FATSAT_TOFSAT");
            param.setDefaultValue("");
            return param;
        }
    },
    ...
    SLAB_OVERLAP("SLAB_OVERLAP") {
        public Param build() {
            ...
            param.setDisplayedName("SLAB_OVERLAP");
            param.setDescription("");
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.PERCENT);
    ...
    TOF2D_FLOW_TAU("TOF2D_FLOW_TAU") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(1.0E9);
            param.setValue(4.9999999999999996E-5);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    TOF2D_SB_DISTANCE_FROM_SLICE("TOF2D_SB_DISTANCE_FROM_SLICE") {
        public Param build() {
            ...
            param.setDisplayedName("TOF SatBand - Distance from FOV");
            param.setDescription("Distance of the TOF satband from the active imaging slice (2D) or imaging volume (3D)");
            param.setGroup(EnumGroup.Dimension);
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.Location);
            param.setMinValue(-1.7976931348623157E308);
    ...
    TOF2D_SB_GRAMP_SP("TOF2D_SB_GRAMP_SP") {
        public Param build() {
            ...
            param.setDisplayedName("TOF SatBand - Spoiler Grad Amp");
    ...
    TOF2D_SB_POSITION("TOF2D_SB_POSITION") {
        public Param build() {
            ...
            param.setDisplayedName("TOF Satband -  Position");
            param.setDescription("TOF Satband position relative to imaging slices");
            param.setGroup(EnumGroup.Dimension);
            param.setCategory(Category.Acquisition);
    ...
    TOF2D_SB_THICKNESS("TOF2D_SB_THICKNESS") {
        public Param build() {
            ...
            param.setDisplayedName("TOF SatBand - Thickness");
            param.setDescription("Thickness of the Saturation Band");
            param.setGroup(EnumGroup.Dimension);
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.Length);
    ...
    TOF3D_MT_BANDWIDTH("TOF3D_MT_BANDWIDTH") {
        public Param build() {
            ...
            param.setDisplayedName("TOF3D_MT_BANDWIDTH");
            param.setDescription("");
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.Frequency);
            param.setMinValue(0.0);
    ...
    TOF3D_MT_FLIP_ANGLE("TOF3D_MT_FLIP_ANGLE") {
        public Param build() {
            ...
            param.setDescription("MT flip angle only for 3D TOF");
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.RotationAngle);
            param.setMinValue(4.9E-324);
            param.setMaxValue(1.7976931348623157E308);
            param.setValue(2880.0);
    ...
    TOF3D_MT_GAMMA_B1("TOF3D_MT_GAMMA_B1") {
        public Param build() {
            ...
            param.setDisplayedName("TOF3D_MT_GAMMA_B1");
            param.setDescription("");
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.Frequency);
            param.setMinValue(0.0);
    ...
    TOF3D_MT_INDIV("TOF3D_MT_INDIV") {
        public Param build() {
            ...
            param.setDisplayedName("TOF3D_MT_INDIV");
            param.setDescription("");
            param.setCategory(Category.Acquisition);
            param.setValue(false);
            param.setDefaultValue(false);
    ...
    TOF3D_MT_TX_LENGTH("TOF3D_MT_TX_LENGTH") {
        public Param build() {
            ...
            param.setDisplayedName("TOF3D_MT_TX_LENGTH");
            param.setDescription("");
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.Time);
            param.setMinValue(0.0);
    ...
    TOF_ENABLED("TOF_ENABLED") {
        public Param build() {
            ...
            param.setDisplayedName("TOF_ENABLED");
            param.setDescription("");
            param.setGroup(EnumGroup.Miscellaneous);
            param.setCategory(Category.Acquisition);
            param.setValue(true);
    ...
    TOF_SB_OFFSET("TOF_SB_OFFSET") {
        public Param build() {
            ...
            param.setDisplayedName("TOF Satband - Offset Frequence");
    ...
    TOF_SB_TX_SHAPE("TOF_SB_TX_SHAPE") {
        public Param build() {
            ...
            param.setDisplayedName("TOF SatBand - TX Shape");
    ...
    TRIGGER_TIME("TRIGGER_TIME") {
        public Param build() {
            ...
            param.setMaxValue(1.0E9);
            param.setNumberEnum(NumberEnum.Time);
            param.setValue(asListNumber(0.0, 37.889, 75.778, 113.667, 151.556));
    ...
    TX_AMP("TX_AMP") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(100.0);
            param.setValue(83.51911111321503);
            param.setDefaultValue(40.0);
            return param;
        }
    },
