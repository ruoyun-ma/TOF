...
public enum U implements GeneratorParamEnum {
    ...
    SEQ_DESCRIPTION("SEQ_DESCRIPTION") {
        public Param build() {
            ...
            param.setDescription("");
            param.setCategory(Category.Acquisition);
            param.setValue("GE_3D_AXI_64x64x64");
            param.setDefaultValue("");
            return param;
        }
    },
    ...
    TRANSFORM_PLUGIN("TRANSFORM_PLUGIN") {
        public Param build() {
            ...
            param.setSuggestedValues(asList("Sequential4D", "Sequential4DBackAndForth", "EPISequential4D", "Centric4D", "Elliptical3D"));
            return param;
        }
    },
    ...
    TX_AMP("TX_AMP") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(100.0);
            param.setValue(41.54606453510697);
            param.setDefaultValue(40.0);
            return param;
        }
    },
