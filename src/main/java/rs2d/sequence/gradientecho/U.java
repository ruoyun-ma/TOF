...
public enum U implements GeneratorParamEnum {
    ...
    FIELD_OF_VIEW_PHASE("FIELD_OF_VIEW_PHASE") {
        public Param build() {
            ...
            param.setDisplayedName("FOV_PHASE");
    ...
    GRADIENT_RISE_TIME("GRADIENT_RISE_TIME") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(1.0E9);
            param.setValue(8.999999999999999E-5);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    PHASE_FIELD_OF_VIEW_RATIO("PHASE_FIELD_OF_VIEW_RATIO") {
        public Param build() {
            ...
            param.setDescription("Fov ratio in the phase direction");
            param.setGroup(EnumGroup.Dimension);
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.PERCENT);
            param.setMinValue(-2.147483648E9);
    ...
    SEQUENCE_TIME("SEQUENCE_TIME") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(1.0E9);
            param.setValue(122.93299999999999);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    SEQ_DESCRIPTION("SEQ_DESCRIPTION") {
        public Param build() {
            ...
            param.setDescription("");
            param.setCategory(Category.Acquisition);
            param.setValue("GE_3D_AXI_128x128x32x3");
            param.setDefaultValue("");
            return param;
        }
    },
    ...
    SPECTRAL_WIDTH("SPECTRAL_WIDTH") {
        public Param build() {
            ...
            param.setValue(32018.44262295082);
    ...
    TOF2D_FLOW_TAU("TOF2D_FLOW_TAU") {
        public Param build() {
            ...
            param.setDisplayedName("TOF2D_FLOW_TAU");
            param.setDescription("");
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.Double);
            param.setMinValue(-1.7976931348623157E308);
    ...
    TOF3D_MT_FLIP_ANGLE("TOF3D_MT_FLIP_ANGLE") {
        public Param build() {
            ...
            param.setMaxValue(1.7976931348623157E308);
            param.setValue(972.0000000000001);
    ...
    TOF3D_MT_TX_LENGTH("TOF3D_MT_TX_LENGTH") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(1.0E9);
            param.setValue(0.054000000000000006);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    TOF_SB_OFFSET("TOF_SB_OFFSET") {
        public Param build() {
            ...
            param.setDisplayedName("TOF_SB_OFFSET");
            param.setDescription("");
            param.setGroup(EnumGroup.Emission);
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.FrequencyOffset);
    ...
    TOF_SB_TX_SHAPE("TOF_SB_TX_SHAPE") {
        public Param build() {
            ...
            param.setDisplayedName("TOF_SB_TX_SHAPE");
            param.setDescription("");
            param.setCategory(Category.Acquisition);
    ...
    TRIGGER_TIME("TRIGGER_TIME") {
        public Param build() {
            ...
            param.setMaxValue(1.0E9);
            param.setNumberEnum(NumberEnum.Time);
            param.setValue(asListNumber(0.0, 500.0, 1000.0));
    ...
    TX_AMP("TX_AMP") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(100.0);
            param.setValue(31.80739866222001);
            param.setDefaultValue(40.0);
            return param;
        }
    },
    ...
    TX_BANDWIDTH_FACTOR_3D("TX_BANDWIDTH_FACTOR_3D") {
        public Param build() {
            ...
            param.setMaxValue(1.7976931348623157E308);
            param.setNumberEnum(NumberEnum.Double);
            param.setValue(asListNumber(1.1, 2.7, 5.1, 8.5, 0.0, 0.0, 8.5));
