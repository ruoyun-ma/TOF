...
public enum U implements GeneratorParamEnum {
    ...
    FATSAT_TX_AMP_90("FATSAT_TX_AMP_90") {
        public Param build() {
            ...
            param.setValue(0.9932207783811425);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    FATSAT_TX_LENGTH("FATSAT_TX_LENGTH") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(1.0E9);
            param.setValue(0.007500000000000001);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    KSPACE_FILLING("KSPACE_FILLING") {
        public Param build() {
            ...
            param.setSuggestedValues(asList("Linear", "Centric", "3DElliptic"));
            return param;
        }
    },
    ...
    SEQ_DESCRIPTION("SEQ_DESCRIPTION") {
        public Param build() {
            ...
            param.setDescription("");
            param.setCategory(Category.Acquisition);
            param.setValue("GE_2D_AXI_64x64x64_TRIG_FATSAT_SATBAND_SATBAND");
            param.setDefaultValue("");
            return param;
        }
    },
    ...
    SPECTRAL_WIDTH("SPECTRAL_WIDTH") {
        public Param build() {
            ...
            param.setValue(550176.0563380282);
    ...
    SPECTRAL_WIDTH_PER_PIXEL("SPECTRAL_WIDTH_PER_PIXEL") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(1.0E8);
            param.setValue(8596.50088028169);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    TRANSFORM_PLUGIN("TRANSFORM_PLUGIN") {
        public Param build() {
            ...
            param.setSuggestedValues(asList("Sequential4D", "Sequential4DBackAndForth", "EPISequential4D", "Elliptical3D"));
            return param;
        }
    },
    ...
    TX_AMP("TX_AMP") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(100.0);
            param.setValue(6.584607485524112);
            param.setDefaultValue(40.0);
            return param;
        }
    },
    ...
    TX_AMP_90("TX_AMP_90") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(100.0);
            param.setValue(63.602051266743395);
            param.setDefaultValue(0.0);
            return param;
        }
    },
