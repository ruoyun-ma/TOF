...
public enum U implements GeneratorParamEnum {
    ...
    FOV_MULTISLAB("FOV_MULTISLAB") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(1.7976931348623157E308);
            param.setValue(0.015000000000000001);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    MAGNETIC_FIELD_STRENGTH("MAGNETIC_FIELD_STRENGTH") {
        public Param build() {
            ...
            param.setMaxValue(100.0);
            param.setValue(3.0);
            param.setDefaultValue(3.0018813806920517);
            return param;
        }
    },
    ...
    SATBAND_FLIP_ANGLE("SATBAND_FLIP_ANGLE") {
        public Param build() {
            ...
            param.setCategory(Category.Acquisition);
            param.setUuid("651054e9-383a-4ba2-a048-44c71ef242a7");
    ...
    SPECTRAL_WIDTH("SPECTRAL_WIDTH") {
        public Param build() {
            ...
            param.setValue(125200.32051282052);
    ...
    SPECTRAL_WIDTH_PER_PIXEL("SPECTRAL_WIDTH_PER_PIXEL") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(1.0E8);
            param.setValue(250.40064102564102);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    TX_AMP("TX_AMP") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(100.0);
            param.setValue(78.47725772952177);
            param.setDefaultValue(40.0);
            return param;
        }
    },
    ...
    TX_BANDWIDTH_FACTOR("TX_BANDWIDTH_FACTOR") {
        public Param build() {
            ...
            param.setMaxValue(1.7976931348623157E308);
            param.setNumberEnum(NumberEnum.Double);
            param.setValue(asListNumber(0.9500000000000001, 1.35, 2.55, 4.25, 8.5152, 4.2576, 4.25));
    ...
    TX_BANDWIDTH_FACTOR_3D("TX_BANDWIDTH_FACTOR_3D") {
        public Param build() {
            ...
            param.setMaxValue(1.7976931348623157E308);
            param.setNumberEnum(NumberEnum.Double);
            param.setValue(asListNumber(1.1, 3.2, 5.0, 7.3, 8.5152, 4.2576, 7.3));
