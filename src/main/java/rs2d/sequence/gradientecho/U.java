...
public enum U implements GeneratorParamEnum {
    ...
    LAST_PUT("LAST_PUT") {
        public Param build() {
            ...
            param.setMaxValue(2147483647);
            param.setNumberEnum(NumberEnum.Integer);
            param.setValue(asListNumber(1, 127, 15, 0, 7));
    ...
    PROBES("PROBES") {
        public Param build() {
            ...
            param.setGroup(EnumGroup.Miscellaneous);
            param.setCategory(Category.Acquisition);
            param.setValue(asList("8RX array 5CM"));
            return param;
        }
    },
    ...
    SEQ_DESCRIPTION("SEQ_DESCRIPTION") {
        public Param build() {
            ...
            param.setDescription("");
            param.setCategory(Category.Acquisition);
            param.setValue("GE_3D_AXI_128x128x16x3_TOFSAT");
            param.setDefaultValue("");
            return param;
        }
    },
    ...
    TRIGGER_TIME("TRIGGER_TIME") {
        public Param build() {
            ...
            param.setMaxValue(1.0E9);
            param.setNumberEnum(NumberEnum.Time);
            param.setValue(asListNumber(0.0, 16.385, 32.77));
    ...
    TX_AMP("TX_AMP") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(100.0);
            param.setValue(88.32995959337244);
            param.setDefaultValue(40.0);
            return param;
        }
    },
