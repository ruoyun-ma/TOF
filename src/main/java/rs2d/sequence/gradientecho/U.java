...
public enum U implements GeneratorParamEnum {
    ...
    NUMBER_OF_SLAB("NUMBER_OF_SLAB") {
        public Param build() {
            ...
            param.setDisplayedName("Nb. Slab");
    ...
    SEQ_DESCRIPTION("SEQ_DESCRIPTION") {
        public Param build() {
            ...
            param.setCategory(Category.Acquisition);
            param.setValue("GE_3D_AXI_256x256x8x4_TOFSAT");
            param.setDefaultValue("");
            return param;
        }
    },
    ...
    SLAB_OVERLAP("SLAB_OVERLAP") {
        public Param build() {
            ...
            param.setDescription("Percentage of the slab volume overlapped with one neighbouring slab");
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.PERCENT);
    ...
    SPACING_BETWEEN_SLAB("SPACING_BETWEEN_SLAB") {
        public Param build() {
            ...
            param.setDescription("Space between slabs");
            param.setCategory(Category.Acquisition);
    ...
    TOF2D_SB_DISTANCE_FROM_SLICE("TOF2D_SB_DISTANCE_FROM_SLICE") {
        public Param build() {
            ...
            param.setDisplayedName("TOF 2D Satband - Distance from FOV");
    ...
    TOF3D_MT_FLIP_ANGLE("TOF3D_MT_FLIP_ANGLE") {
        public Param build() {
            ...
            param.setDisplayedName("TOF 3D MT Sat - Flip Angle");
    ...
    TRIGGER_TIME("TRIGGER_TIME") {
        public Param build() {
            ...
            param.setMaxValue(1.0E9);
            param.setNumberEnum(NumberEnum.Time);
            param.setValue(asListNumber(0.0, 221.185, 442.37, 663.5550000000001, 884.74));
